...
Dois tópicos desse estudo (MODELO LINEAR NORMAL e MODELO GAMA LOG-LINEAR) se concentram em uma amostra de 183 países distintos no ano
...
- $X_1, X_2, ..., X_p$ são as variáveis independentes (como histórico de pagamentos, dívida pendente, etc.)

- $\beta_0, \beta_1, ..., \beta_p$ são os coeficientes que medem o impacto de cada variável independente na probabilidade de ser classificado como "Good".
